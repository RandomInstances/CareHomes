    ...
    <>
      ...
      <main className="mx-auto max-w-6xl px-5 py-8 flex-1 w-full">
        <nav className="text-sm text-[--ch-muted] mb-4">
          <Link href="/" className="hover:text-[--ch-ink]">
            Colombo
          </Link>
          <span className="mx-1.5">/</span>
          <span className="text-[--ch-ink]">{suburb.name}</span>
        </nav>
        ...
        {homes.length === 0 ? (
          <div className="bg-[--ch-surface] border border-[--ch-line] rounded-2xl p-10 text-center">
            ...
            <Link href="/" className="inline-block mt-3 text-sm font-semibold text-[--ch-teal]">
